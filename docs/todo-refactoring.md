...
| ~~中~~ | ~~1.1 getEditTarget/getDeleteTarget 統合~~ | ~~重複排除~~ | ✅ 完了 |
| ~~中~~ | ~~1.2 commentTypes 定数化~~ | ~~重複排除~~ | ✅ 完了 |
| ~~中~~ | ~~1.4 リアクション再取得統合~~ | ~~重複排除~~ | ✅ 完了 |
| ~~中~~ | ~~1.5 handleApprove/Revoke 統合~~ | ~~重複排除~~ | ✅ 完了 |
| ~~中~~ | ~~3.3 Props グループ化~~ | ~~リファクタ~~ | ✅ 完了 |
| ~~中~~ | ~~2.5 formatDiff.ts 整理~~ | ~~デッドコード~~ | ✅ 完了 |
